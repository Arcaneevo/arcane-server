...
const supabase = createClient(
  ...
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhqdGpjd2F0c2VicnJnYW9namR5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDM3MTI5MDgsImV4cCI6MjA1OTI4ODkwOH0.WWXBmZEVNGT5Gy9D0TbmuH2kRKtcibBN1JLbw8MpAkI'
);
...
httpServer.listen(PORT, () => {
  ...
  console.log(`🌐 Ngrok URL: https://unlaced-impulse-unclothed.ngrok-free.dev`);
});
